...
void Hero::fire(df::Vector target) {
  ...
  /*
  LM.writeLog("New Velocity: (%f,%f)", df::Vector(p->getVelocity().getX(),
	  (target.getY() - getPosition().getY()) /
	  (target.getX() - getPosition().getX())).getX(), df::Vector(p->getVelocity().getX(),
	  (target.getY() - getPosition().getY()) /
		  (target.getX() - getPosition().getX())).getY());
		  */
}
